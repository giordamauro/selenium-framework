...
public class BasicAbstractElementHandlerImpl implements BasicAbstractElementHandler {

	private static final Log staticLogger = LogFactory.getLog(BasicAbstractElementHandlerImpl.class);
	...
	public BasicAbstractElementHandlerImpl(WebDriver driver, WebDriverWait driverWait, ApplicationContext applicationContext) {
	...
	public BasicAbstractElementHandlerImpl(BasicAbstractElementHandlerImpl elementHandler, PageElement rootElement) {
