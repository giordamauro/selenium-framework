...
public class WebDriverHandler {
	...
	private static final Log logger = LogFactory.getLog(WebDriverHandler.class);

	private final Map<Browser, BrowserFactory> browserFactories;

	private final int timeOutSeconds;

	public WebDriverHandler(Map<Browser, BrowserFactory> browserFactories, int timeOutSeconds) {
